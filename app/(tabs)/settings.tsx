        ...
        <Section title="Wallpaper" accent={theme.accent}>
          <Row
            ...
            right={
              <Switch
                value={bgMode === 'custom'}
                onValueChange={(val) => setBgMode(val ? 'custom' : 'adaptive')}
                thumbColor={bgMode === 'custom' ? theme.accent : theme.muted}
                trackColor={{ false: 'rgba(255,255,255,0.1)', true: theme.accent + '80' }}
              />
            }
          />
          {bgMode === 'custom' && (
              ...
              {[0, 15, 30, 60].map((mins) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    (mins === 0 && sleepTimer === 0) ||
                    (mins > 0 && Math.abs(sleepTimer - mins * 60) < 60)
                  ...
                  <Text
                    style={{
                      color:
                        mins === 0 || (mins > 0 && Math.abs(sleepTimer - mins * 60) < 60)
                          ? theme.accent
                          : theme.muted,
                      fontSize: 13,
                      fontWeight: '600',
          ...
          <Row
            ...
            right={
              <Switch
                ...
                thumbColor={shuffle ? theme.accent : theme.muted}
                trackColor={{ false: 'rgba(255,255,255,0.1)', true: theme.accent + '80' }}
              />
            }
          />
          <Row
            ...
            right={
              <Switch
                ...
                thumbColor={repeat ? theme.accent : theme.muted}
                trackColor={{ false: 'rgba(255,255,255,0.1)', true: theme.accent + '80' }}
              />
            }
          />
